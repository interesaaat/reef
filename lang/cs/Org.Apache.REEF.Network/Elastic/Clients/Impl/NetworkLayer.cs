...
namespace Org.Apache.REEF.Network.Group.Task.Impl
{
    ...
    /// Writable version
    /// </summary>
    internal sealed class NetworkLayer : IObserver<IRemoteMessage<NsMessage<GeneralGroupCommunicationMessage>>>
    {
        ...
        public TaskMessageObserver RegisterAndGetForTask(string taskSourceId)
        {
            ...
            return _taskMessageObservers.GetOrAdd(taskSourceId, new TaskMessageObserver(_networkService));
        }

...
namespace Org.Apache.REEF.Network.Elastic.Task.Impl
{
    ...
    /// </summary>
    internal sealed class CheckpointMessageStreamingCodec : IStreamingCodec<CheckpointMessage>
    {
        private readonly IStreamingCodec<CheckpointState> _codec;

        /// <summary>
        /// Empty constructor to allow instantiation by reflection
        /// </summary>
        [Inject]
        private CheckpointMessageStreamingCodec(IStreamingCodec<CheckpointState> codec)
        {
            _codec = codec;
        }
        ...
        public CheckpointMessage Read(IDataReader reader)
        {
            ...
            return new CheckpointMessage(subscriptionName, operatorId, iteration);
        }
        ...
        public void Write(CheckpointMessage obj, IDataWriter writer)
        {
            ...
            _codec.Write(obj.Payload, writer);
        }
            ...
            CancellationToken token)
        {
            ...
            return new CheckpointMessage(subscriptionString, operatorId, iteration);
        }
        ...
        public async System.Threading.Tasks.Task WriteAsync(CheckpointMessage obj, IDataWriter writer, CancellationToken token)
        {
            ...
            await _codec.WriteAsync(obj.Payload, writer, token);
        }

...
namespace Org.Apache.REEF.Network.Group.Driver.Impl
{
    ...
    /// </summary>
    public sealed class GroupCommunicationServiceDriver : IGroupCommunicationServiceDriver
    {
        ...
        private static readonly Logger Logger = Logger.GetLogger(typeof(GroupCommunicationServiceDriver));
        ...
        private readonly Dictionary<string, IGroupCommunicationSubscriptionDriver> _commGroups;
        private readonly AvroConfigurationSerializer _configSerializer;
        private readonly object _groupsLock = new object();

        /// <summary>
        /// Create a new GroupCommunicationServiceDriver object.
        /// </summary>
        ...
        [Inject]
        private GroupCommunicationServiceDriver(
            ...
            INameServer nameServer)
        {
            ...
            _commGroups = new Dictionary<string, IGroupCommunicationSubscriptionDriver>();
        ...
        public IGroupCommunicationSubscriptionDriver DefaultGroup
        {
            get
            {
                lock (_groupsLock)
                {
                    IGroupCommunicationSubscriptionDriver defaultGroup;
        ...
        public IGroupCommunicationSubscriptionDriver NewCommunicationGroup(string groupName, int numTasks)
        {
        ...
        /// <summary>
        /// Remove a group from the GroupCommunicationServiceDriver
        ...
        public IConfiguration GetGroupCommTaskConfiguration(string taskId)
        {
            ...
            foreach (IGroupCommunicationSubscriptionDriver commGroup in _commGroups.Values)
            {

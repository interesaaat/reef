...
namespace Org.Apache.REEF.Network.Examples.Elastic
{
    ...
    /// </summary>
    public class ElasticConditionalIterateBroadcastDriver : 
    ...
    {
        private static readonly Logger LOGGER = Logger.GetLogger(typeof(ElasticConditionalIterateBroadcastDriver));
        ...
        [Inject]
        private ElasticConditionalIterateBroadcastDriver(
            ...
            IEvaluatorRequestor evaluatorRequestor)
        {
            ...
            IConfiguration iteratorConfig = TangFactory.GetTang().NewConfigurationBuilder()
                //.BindImplementation(typeof(ElasticIteratorEnumerator<>), typeof(IterateBroadcastCondition))
               .Build();
        ...
        public void OnNext(IDriverStarted value)
        {
            var request = _evaluatorRequestor.NewBuilder()
                ...
                .SetEvaluatorBatchId("IterateConditionalBroadcastEvaluator")
                .Build();
